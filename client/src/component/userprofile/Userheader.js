  ...
  const handleClose = () => {
   ...
   //  }
	...
	return (
        ...
        <div className="PagePanel Reminders accent-color userprofile-header">
   ...
   <div id="ember41" className="ember-view">
      <div className="container-fluid shadow-z-1">
         ...
         <section className="ProfileUser-header PageBanner primary-background-color">
           <div id="ember656" className="large UserAvatar ember-view">  
           ...
           <div className="ProfileUser-body">
             <h1 className="ProfileUser-name">Kyle Fisher</h1>
             <p className="ProfileUser-meta">CTO</p>
           </div>
         </section>
      </div>
   </div>
